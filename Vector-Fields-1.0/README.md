...
<h1 align="center">Vector Fields 1.0</h1>

## Overview

This project visualizes vector fields in augmented reality using procedurally generated tube meshes that deform along field lines. This is the base version with analytical field presets. For AI-generated fields from text prompts, see [Vector-Fields-2.0](../Vector-Fields-2.0/).
